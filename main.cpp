...
int main()
{
	...
	//ser.start();
	/**/
	aq::extraction::MultipleBmpExtractor extractor;
	...
	analyze::algorithm::ObjectDetector detector = analyze::algorithm::ObjectDetector(common::Context::getInstance()->getOpimalThreadsCount());
